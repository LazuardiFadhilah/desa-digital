...
export default function KeluargaPage() {
  return (
    <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100 flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <h1 className="text-2xl font-bold text-gray-800 mb-2">Data Keluarga</h1>
      <p className="text-gray-500 max-w-md">
        Halaman ini sedang dalam pengembangan. Fitur pengelolaan data keluarga desa akan segera hadir di sini.
      </p>
    </div>
  )
}
