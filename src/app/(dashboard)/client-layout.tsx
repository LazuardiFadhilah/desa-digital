...
const MENU_ITEMS = [
  ...
  { name: 'Data Keluarga', path: '/keluarga', icon: Users },
  { name: 'Bantuan Sosial', path: '/bansos', icon: HandHeart },
  { name: 'Kegiatan Desa', path: '/kegiatan', icon: Calendar },
  { name: 'Surat & Izin', path: '/surat', icon: FileText },
  { name: 'Retribusi', path: '/retribusi', icon: Wallet },
]
